...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'reem.waleed.ahmed@gmail.com'  # ✅ Your Gmail configured
EMAIL_HOST_PASSWORD = 'lsjp pfal ycbl zjdr'  # ✅ Your App Password configured

# Always use SMTP backend to actually send emails
# Remove the console backend override for debug mode