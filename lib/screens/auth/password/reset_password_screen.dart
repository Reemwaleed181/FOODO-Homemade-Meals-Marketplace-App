  ...
  Future<void> _handleResetPassword() async {
    ...
    try {
      ...
      await authProvider.resetPassword(
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Row(
                ...
                SizedBox(width: 12),
                Expanded(child: Text('Password reset successfully! You can now login with your new password')),
              ],
            ),
        ...
        Provider.of<NavigationProvider>(context, listen: false).navigateTo(AppPage.login);
      }
    } catch (e) {
      setState(() {
